...
static int validity1(void) {
	...
	RLC_TRY {
		...
		TEST_END;
		TEST_CASE("validity test is correct-tate") {
			g1_set_infty(a);
			TEST_ASSERT(!g1_is_valid_tate(a,b), end);
			g1_rand(a);
			TEST_ASSERT(g1_is_valid_tate(a, b), end);
		}
		TEST_END;

		TEST_CASE("validity test is correct-tate_pre") {
			g1_set_infty(a);
			TEST_ASSERT(!g1_is_valid_tate_pre(a,b, tab), end);
			g1_rand(a);
			TEST_ASSERT(g1_is_valid_tate_pre(a, b, tab), end);
		}
		TEST_END;
