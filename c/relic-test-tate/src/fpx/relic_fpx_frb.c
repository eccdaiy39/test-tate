...
static void fp13_mul_frb(fp13_t c, const fp13_t a,int i){
	ctx_t *ctx = core_get();
	switch(i%13){
		case 0:
			fp13_copy(c,a);
		...
		case 1:
			fp_copy(c[0],a[0]);
			for(int i=1;i<13;i++)
				fp_mul(c[i],a[i],ctx->frb13_1[i-1]);
			break;
		case 2:
			fp_copy(c[0],a[0]);
			for(int i=1;i<13;i++)
				fp_mul(c[i],a[i],ctx->frb13_2[i-1]);
			break;
		case 3:
			fp_copy(c[0],a[0]);
			for(int i=1;i<13;i++)
				fp_mul(c[i],a[i],ctx->frb13_3[i-1]);
			break;
		case 4:
			fp_copy(c[0],a[0]);
			for(int i=1;i<13;i++)
				fp_mul(c[i],a[i],ctx->frb13_4[i-1]);
			break;
		case 5:
			fp_copy(c[0],a[0]);
			for(int i=1;i<13;i++)
				fp_mul(c[i],a[i],ctx->frb13_5[i-1]);
			break;
		case 6:
			fp_copy(c[0],a[0]);
			for(int i=1;i<13;i++)
				fp_mul(c[i],a[i],ctx->frb13_6[i-1]);
			break;
		case 7:
			fp_copy(c[0],a[0]);
			for(int i=1;i<13;i++)
				fp_mul(c[i],a[i],ctx->frb13_7[i-1]);
			break;
		case 8:
			fp_copy(c[0],a[0]);
			for(int i=1;i<13;i++)
				fp_mul(c[i],a[i],ctx->frb13_8[i-1]);
			break;
		case 9:
			fp_copy(c[0],a[0]);
			for(int i=1;i<13;i++)
				fp_mul(c[i],a[i],ctx->frb13_9[i-1]);
			break;
		case 10:
			fp_copy(c[0],a[0]);
			for(int i=1;i<13;i++)
				fp_mul(c[i],a[i],ctx->frb13_10[i-1]);
			break;
		case 11:
			fp_copy(c[0],a[0]);
			for(int i=1;i<13;i++)
				fp_mul(c[i],a[i],ctx->frb13_11[i-1]);
			break;
  		 case 12:
			fp_copy(c[0],a[0]);
			for(int i=1;i<13;i++)
				fp_mul(c[i],a[i],ctx->frb13_12[i-1]);
			break;
